...
let createbutton=(idname,classname)=>{
    ...
    div2.append(createbutton("1","fst"));
    div2.append(createbutton("2","scnd"));
    div2.append(createbutton("3","thrd"));
    div2.append(createbutton("4","fth"));
    div2.append(createbutton("5","fft"));
    div2.append(createbutton("6","sxt"));
    div2.append(createbutton("7","st"));
    div2.append(createbutton("8","et"));
    div2.append(createbutton("9","nt"));
    div2.append(createbutton("10","tt"));
    ...
    var data=[
      ...
      var displayData=(a,b)=>{
        ...
        for (let index = parseInt(a); index <parseInt(b); index++) {
            displayContent+= (index+1)+". The id of person   is  "+JSON.stringify(data[index].id)+" . ";
            displayContent+= "The name of person    is "+JSON.stringify(data[index].name)+" . ";
            displayContent+= "The email of person   is "+JSON.stringify(data[index].email)+" .     ";
